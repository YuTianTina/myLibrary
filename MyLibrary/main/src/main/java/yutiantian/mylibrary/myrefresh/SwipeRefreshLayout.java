...
package yutiantian.mylibrary.myrefresh;
...
public class SwipeRefreshLayout extends ViewGroup {
	...
	private void createHeadView(Context context) {
		...
		imgHeadView=new ImageView(context);
		imgHeadView.setImageResource(R.mipmap.refresh_arrow);
		tvHeadView=new TextView(context);
		tvHeadView.setText("下拉刷新");
		ll.addView(imgHeadView);
		ll.addView(tvHeadView);
		mHeaderView=ll;
		addView(mHeaderView);
	}
...
//		}
	...
	private void startRefresh() {
		...
		tvHeadView.setText("加载中...");
		if(imgHeadView.getRotation()==180f){
			imgHeadView.setRotation(0);
		}
		imgHeadView.setImageDrawable(getContext().getDrawable(R.drawable.house_animlist));
		imgHeadView.setImageResource(R.drawable.house_animlist);
        AnimationDrawable animationDrawable= (AnimationDrawable) imgHeadView.getDrawable();
